...
const orderSchema = new Schema({
    ...
    status: {
        type: String,
        enum: ['Waiting_Proof', 'delivered', 'pending', 'processing'],
        default: 'pending'
    },
    order_source: {
        type: String,
    ...
    payment_status: {
        type: String,
        enum: ['pending', 'awaiting_verification', 'verified'],
        default: 'pending'
    },
    ...
    receipt_transport: Number,
    receipt_updated_at: Date,
    receipt_updated_by: mongoose.Schema.Types.ObjectId,
    verified_at: Date,
    delivered_at: Date,
    created_at: {
        type: Date,
